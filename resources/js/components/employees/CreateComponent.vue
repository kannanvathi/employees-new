            ...
            <form @submit.prevent="storeEmployee()" >
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        ...
                        <datepicker v-model="formData.birth_date" input-class="form-control" name="birth_date"></datepicker>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <datepicker v-model="formData.hired_date" input-class="form-control" name="hired_date"></datepicker>
                        <span class="invalid-feedback" role="alert">
                                    <strong></strong>
                                </span>
                    </div>
        ...
        methods: {
            ...
            storeEmployee() {
                this.submitData = {
                    ...
                    birthdate: this.formatDate(this.formData.birth_date),
                    date_hired: this.formatDate(this.formData.hired_date),
                }

                    axios.
                        post('api/employees', this.submitData)
                .then(res => {
